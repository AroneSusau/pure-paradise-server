...
const items = new Map<number, Item>([
    ...
    // Consumables
    [ItemId.APPLE, new Food(ItemId.APPLE, 'Apple', 'An apple a day keeps the doctor away!', 9, 2)],
    [ItemId.BEEF, new Food(ItemId.BEEF, 'Beef', 'Man needs his beef.', 31, 24)],
    [ItemId.DONUT, new Food(ItemId.DONUT, 'Donut', 'Mmmmmm, donuts.', 26, 14)],
    [ItemId.HAMBURGER, new Food(ItemId.HAMBURGER, 'Hamburger', 'Holy cow where did you get this hamburger!', 110, 30)],
    [ItemId.FLESH, new Food(ItemId.FLESH, 'Flesh', 'Uhmm.. if you\'re hungry enough?', 1, 1)],
    [ItemId.PEANUTS, new Food(ItemId.PEANUTS, 'Peanuts', 'A little salty if you ask me.', 9, 1)],
    [ItemId.PIE, new Food(ItemId.PIE, 'Pie', 'At least its still wrapped', 14, 4)],
    [ItemId.WATER, new Food(ItemId.WATER, 'Water', 'A bit of H2O never hurt anyone', 25, 16)],
    ...
    // Edible Weapon
    [ItemId.CHOCOLATE_SWORD, new EdibleWeapon(ItemId.CHOCOLATE_SWORD, 'Chocolate Sword', 'A tasty treat that should do the trick!', 5, 1, 1)],

    // Defensive Items
    [ItemId.CLOTH_CLOTHING, new Armour(ItemId.CLOTH_CLOTHING, 'Cloth Clothing', 'Ain\'t nothing better than some cloth clothing, fresh from the sheep.', 15, 2)],
